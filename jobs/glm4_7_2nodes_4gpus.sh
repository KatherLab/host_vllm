...
# - 358B total parameters, sparse MoE architecture
# - 131K context window
# - FP8 quantization for 8-bit inference - requires 8 GPUs (2 nodes x 4 GPUs)
# Requirements: vllm>=0.15.0

# Use config values if available, otherwise use defaults
VLLM_MODEL="${VLLM_CONFIG_HF_ID:-zai-org/GLM-4.7-FP8}"
VLLM_PORT="${VLLM_CONFIG_PORT:-8002}"
...
echo "Starting GLM-4.7 (358B MoE) on 2 nodes (8 GPUs) with FP8 quantization..."
